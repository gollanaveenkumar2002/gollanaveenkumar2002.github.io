    ...
    return (
        <nav className={isScrolled ? 'scrolled' : ''}>
            <div className="nav-content">
                <a href="#" className="logo">NAVEEN KUMAR GOLLA</a>
                ...
                <div className="hamburger" onClick={toggleMobileMenu} aria-label="Toggle navigation menu" role="button" tabIndex={0} onKeyDown={(e) => e.key === 'Enter' && toggleMobileMenu()}>
                    <span></span>
                    <span></span>
                    <span></span>
                </div>
