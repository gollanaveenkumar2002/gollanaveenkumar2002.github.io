const Skills = () => {
    const skillsData = [
        ...
        },
        {
            ...
            tags: ['GPT-4', 'Claude', 'Llama', 'Ollama', 'HuggingFace', 'QLoRA']
        },
        {
            icon: 'fab fa-react',
