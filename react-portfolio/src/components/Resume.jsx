                ...
                <div className="resume-container resume-hidden" id="resume-content">
                    ...
                    <div className="resume-section">
                        ...
                        <div className="resume-skills-grid">
                            ...
                            <div className="resume-skill-category">
                                <strong>Generative AI & LLMs:</strong> GPT-4, GPT-3.5, Claude, Llama, Gemini, Ollama, OpenAI API,
                                Retrieval-Augmented Generation (RAG), Vector Databases (Pinecone, Qdrant), Neo4j, Embeddings,
                                Transformer Models, Prompt Engineering, QLoRA Fine-tuning, AI Agents, LangChain, LangGraph,
                                LlamaIndex, CrewAI, n8n, MCP (Model Context Protocol), Groq API, Hugging Face Transformers
                            </div>
                            <div className="resume-skill-category">
                        ...
                        <div className="resume-job">
                            <div className="resume-job-header">
                                <div>
                                    ...
                                    <div className="resume-company">CogniNode Technologies | Hyderabad, India</div>
                                </div>
                                <div className="resume-date">Oct 2025 - Feb 2026</div>
                            </div>
                            <ul className="resume-list">
                                <li>Researched and prototyped ML-based threat detection pipelines focusing on identifying malicious patterns using TensorFlow/Keras</li>
                                <li>Designed and tested a Malicious URL Detection system achieving high classification accuracy across phishing, malware, and benign URLs</li>
                                <li>Integrated cybersecurity principles into AI model design, ensuring adversarial robustness and reduced false-positive rates</li>
                                <li>Contributed to internal research documentation and threat intelligence reports, translating technical findings into actionable insights</li>
                            </ul>
                        </div>
                    ...
                    <div className="resume-section">
                        ...
                        <div className="resume-project">
                            <h3>Telangana High Court Cause-List Automation</h3>
                            <div className="resume-tech">Python | GitHub Actions | CI/CD | Green-API | Headless Chrome | Web Scraping</div>
                            <ul className="resume-list">
                                <li>Architected an autonomous, zero-cost, serverless pipeline on GitHub Actions to scrape daily advocate cause lists from the Telangana High Court portal</li>
                                <li>Engineered a headless Chrome automation system to generate high-fidelity PDF reports via native browser printing</li>
                                <li>Integrated Green-API to bypass QR-code dependencies, delivering targeted PDF reports directly to specific WhatsApp groups and private numbers</li>
                                <li>Implemented a robust cron-based scheduling system with timezone synchronization to ensure pinpoint delivery precision at 21:00 IST daily</li>
                                <li>Developed dynamic target resolution logic converting client variables and group names into correct WhatsApp IDs</li>
                                <li>Built automated CSV delivery logging sent directly to administrator endpoints for daily delivery verification</li>
                            </ul>
                        </div>
